...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  png_structp png_ptr;
    ...
    printf("Successfully completed (should not reach here if overflow detected)\n");
    return 0;
}
