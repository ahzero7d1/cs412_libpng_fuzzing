...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  png_set_compression_level(png_handler.png_ptr, compression_level);  // NEW
  png_set_filter(png_handler.png_ptr, PNG_FILTER_TYPE_BASE, PNG_ALL_FILTERS);  // NEW
  ...
  text_ptr[1].text = fuzz_buf;  // NEW: use fuzz data as second text chunk
